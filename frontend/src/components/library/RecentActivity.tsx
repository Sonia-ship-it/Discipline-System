...
import { Clock, BookOpen, CheckCircle, XCircle, AlertCircle, ArrowRight } from 'lucide-react';
...
export default function RecentActivity({ activities, isLoading = false, userRole = 'STUDENT' }: RecentActivityProps) {
  const router = useRouter();

  const handleViewAllActivity = () => {
    const notificationsPath = userRole === 'LIBRARIAN' 
